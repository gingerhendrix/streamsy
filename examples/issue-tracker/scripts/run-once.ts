...
const runtime = ManagedRuntime.make(applicationLayer(process.env.ISSUE_TRACKER_DB ?? "issue-tracker.sqlite"));
try { console.log(await runtime.runPromise(Projection.run(issueRows.member({ workspaceId })))); }

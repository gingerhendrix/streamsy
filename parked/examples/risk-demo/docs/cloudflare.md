...
> Evidence status: the Worker and browser bundle can be built locally, but this
> branch has not been deployed or smoke-tested against live Cloudflare. The
> commands below require an authenticated Cloudflare/Alchemy environment.

...
function projectAll(events: readonly GameEvent[]): ProjectionState {
  ...
  events.forEach((event, index) => {
    state = projectEvent(state, event, `0000000000000000${index}_0000000000`, index);
  });
  return state;
}
 ...
 */
const PINNED_REDUCER_VERSION = "hex-domination:board-3";
const PINNED_ROSTER_HASH = "ae2d68a5";

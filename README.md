...
- a transport-neutral protocol client (`@streamsy/core` `directProtocolClient`, `@streamsy/http-client` `officialProtocolClient`) with checkpointed batch reads and result-object outcomes

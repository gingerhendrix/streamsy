...
import { DurableObjectStreamStorage } from "@streamsy/storage/durable-object/storage";
...
- **[JSON mode](/docs/user/json-mode)** (`@streamsy/core/json`) — typed JSON messages validated through a codec or Standard Schema.

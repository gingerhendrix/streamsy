import { create } from "../../src/protocol/create.ts";
import { MutationRejected } from "../../src/storage/mutation.ts";
import { expect, it } from "bun:test";
import { Cause, Deferred, Effect, Exit, Fiber, Layer, Option, Stream } from "effect";
import { TestClock } from "effect/testing";
import { StreamsReader, StreamsWriter } from "../../src/protocol/tags.ts";
import * as Protocol from "../../src/protocol/layer.ts";
import { touch } from "../../src/protocol/expiry.ts";
import { StreamId, ProducerId } from "../../src/schema/index.ts";
import { ZERO_OFFSET, next } from "../../src/offset/index.ts";
import { Storage } from "../../src/storage/storage.ts";
import { StorageFault } from "../../src/fault.ts";
import { layerTest, StreamsTest } from "../../src/testing/streams-test.ts";
import { faultyStorage } from "../../src/testing/fault-injection.ts";
import * as Memory from "../../src/storage/memory/layer.ts";

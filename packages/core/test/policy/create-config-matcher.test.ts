...
import { configMatches } from "../../src/policy/create-config-matcher.ts";
import { ZERO_OFFSET } from "../../src/offset/index.ts";
import { StreamRecord, StreamId, Offset } from "../../src/schema/index.ts";
...
function makeRecord(
  ...
  return {
    ...
    lifecycle: {
      forkedFrom:
        overrides.forkedFrom === undefined ? undefined : StreamId.make(overrides.forkedFrom),
      forkOffset:
        overrides.forkOffset === undefined ? undefined : Offset.make(overrides.forkOffset),
